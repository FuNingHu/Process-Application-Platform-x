...
@Component({
    templateUrl: './pap-pg-weld-replay.component.html',
    styleUrls: ['./pap-pg-weld-replay.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})

export class PapPgWeldReplayComponent implements OnChanges, ProgramPresenter {
    ...
    @Input() contributedNode: PapPgWeldReplayNode;
