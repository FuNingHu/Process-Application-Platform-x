...
@Component({
  selector: 'app-weld-parameters-dialog',
  imports: [CommonModule, TranslateModule],
  templateUrl: './weld-parameters-dialog.html',
  styleUrl: './weld-parameters-dialog.scss',
})
export class WeldParametersDialog implements OnChanges {
